...
DC_BuildingsPlotButton = ISButton:derive("DC_BuildingsPlotButton")

function DC_BuildingsPlotButton:applyPlot(plot, selected)
    self.plot = plot
...
function DC_BuildingsPlotButton:new(x, y, width, height, title, target, onclick)
