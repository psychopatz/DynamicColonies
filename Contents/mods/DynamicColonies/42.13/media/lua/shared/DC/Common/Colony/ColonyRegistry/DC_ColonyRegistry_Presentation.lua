...
function Registry.GetWorkerSummary(worker)
    ...
    return {
        ...
        tiredness = worker.tiredness,
        tirednessCurrent = worker.tirednessCurrent or 0,
        tirednessMax = worker.tirednessMax or 0,
        tirednessRatio = worker.tirednessRatio or 0,
        tirednessLowThreshold = worker.tirednessLowThreshold or 0,
        isRestingForTiredness = worker.isRestingForTiredness == true,
        tirednessRecoveryMultiplier = worker.tirednessRecoveryMultiplier or 1,
