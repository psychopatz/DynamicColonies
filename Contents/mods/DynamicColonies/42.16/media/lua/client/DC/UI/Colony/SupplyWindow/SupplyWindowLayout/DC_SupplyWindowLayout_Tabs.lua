...
function DC_SupplyWindow:refreshTabButtons()
...
function DC_SupplyWindow:onSelectProvisionsTab()
    self:setActiveTab(Internal.Tabs.Provisions)
end

function DC_SupplyWindow:onSelectOutputTab()
    self:setActiveTab(Internal.Tabs.Output)
end

function DC_SupplyWindow:onSelectEquipmentTab()
